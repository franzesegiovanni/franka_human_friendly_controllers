...
"""autogenerated by genpy from franka_gripper/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  ...
  _type = "franka_gripper/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = franka_gripper.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = franka_gripper.msg.MoveFeedback()
