...
"""autogenerated by genpy from franka_gripper/GraspActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GraspActionFeedback(genpy.Message):
  ...
  _type = "franka_gripper/GraspActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/GraspFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = franka_gripper.msg.GraspFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = franka_gripper.msg.GraspFeedback()
