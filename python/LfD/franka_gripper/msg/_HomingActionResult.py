...
"""autogenerated by genpy from franka_gripper/HomingActionResult.msg. Do not edit."""
import codecs
import sys
...
class HomingActionResult(genpy.Message):
  _md5sum = "89dbc4e75593b525bbbea3a150532ed6"
  _type = "franka_gripper/HomingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/HomingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HomingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = franka_gripper.msg.HomingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = franka_gripper.msg.HomingResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.error = str[start:end].decode('utf-8', 'rosmsg')
      else:
