...
"""autogenerated by genpy from franka_gripper/MoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveActionResult(genpy.Message):
  ...
  _type = "franka_gripper/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = franka_gripper.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = franka_gripper.msg.MoveResult()
