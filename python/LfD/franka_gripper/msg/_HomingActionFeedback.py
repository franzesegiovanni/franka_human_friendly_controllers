...
"""autogenerated by genpy from franka_gripper/HomingActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class HomingActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "franka_gripper/HomingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/HomingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HomingActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = franka_gripper.msg.HomingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = franka_gripper.msg.HomingFeedback()
