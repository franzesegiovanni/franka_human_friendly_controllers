...
"""autogenerated by genpy from franka_gripper/GraspAction.msg. Do not edit."""
import codecs
import sys
...
class GraspAction(genpy.Message):
  _md5sum = "6f89449359949eaf1f0fef57b7e0db2a"
  _type = "franka_gripper/GraspAction"
...
"""
  ...
  _slot_types = ['franka_gripper/GraspActionGoal','franka_gripper/GraspActionResult','franka_gripper/GraspActionFeedback']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_5d3I().pack(_x.action_goal.goal.width, _x.action_goal.goal.epsilon.inner, _x.action_goal.goal.epsilon.outer, _x.action_goal.goal.speed, _x.action_goal.goal.force, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.width, _x.action_goal.goal.epsilon.inner, _x.action_goal.goal.epsilon.outer, _x.action_goal.goal.speed, _x.action_goal.goal.force, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_5d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
