...
"""autogenerated by genpy from franka_gripper/StopActionResult.msg. Do not edit."""
import codecs
import sys
...
class StopActionResult(genpy.Message):
  _md5sum = "89dbc4e75593b525bbbea3a150532ed6"
  _type = "franka_gripper/StopActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_gripper/StopResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StopActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = franka_gripper.msg.StopResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = franka_gripper.msg.StopResult()
